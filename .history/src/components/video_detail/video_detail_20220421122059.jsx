...
const VideoDetail = (props) => {
    ...
    return <div className={styles.detail_container}>
        ...
        <h3 className={styles.video_channelTitle}>{decodeHTML(props.video.snippet.channelTitle)}</h3>
        <h4 className={styles.video_description}>{decodeHTML(props.video.snippet.description)}</h4>
    </div>
